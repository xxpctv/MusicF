...
class Spider(Spider):  # 元类 默认的元类 type
	...
	def getCookie(self):
		try:
			cookies_str = self.fetch("DedeUserID=690781341;DedeUserID__ckMd5=cabc96906269c5b6;SESSDATA=2245ba24%2C1684212125%2C466fd%2Ab2;bili_jct=de6fdb60c10f8a83910aa55d79407b4e").text
